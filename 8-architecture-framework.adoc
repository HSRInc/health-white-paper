...
This is a first White Paper advocating for the development of Health Spatial Data Infrastructure. Future work towards this end can involve: 

*	Reviewing and expanding on the initiatives included in Chapter 3
*	Identify new use cases for a Health SDI for inclusion in Chapter 4  
*	Update the data considerations in Chapter 5 

Use cases of Health SDI should certainly be expected to grow. For instance, disruptions in the supply chain of medical resources has been identified as a key challenge in pandemic response that a Health SDI can be leveraged to track – as well as potentially anticipate such disruptions in advance so contingencies can be planned. 
