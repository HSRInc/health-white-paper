...
The following initiatives (including standards and projects) were investigated for the purpose of extracting patterns and best practices to build the Health Spatial Data Infrastructure. These are examples that may provide input into an OGC-standards based apporach to develop an SDI. 
...
Numerous additional initiatives exsits that can provide valuabel input towards the creation of Health SDI. While an exaustive list in not possible, the following are worth consideration:
